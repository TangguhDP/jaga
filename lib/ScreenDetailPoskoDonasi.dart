...
import './ScreenDonasi.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:flutter_svg/flutter_svg.dart';

class ScreenDetailPoskoDonasi extends StatelessWidget {
  ScreenDetailPoskoDonasi({
    Key key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromSize(
            bounds: Rect.fromLTWH(0.0, 80.0, 360.0, 268.0),
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(0.0, 80.0, 360.0, 164.0),
            size: Size(360.0, 640.0),
            pinLeft: true,
            pinRight: true,
            pinTop: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(-16.0, 252.0, 392.0, 72.0),
            size: Size(360.0, 640.0),
            pinLeft: true,
            pinRight: true,
            fixedHeight: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(140.0, 332.0, 80.0, 8.0),
            size: Size(360.0, 640.0),
            fixedWidth: true,
            fixedHeight: true,
            child:
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(16.0, 281.0, 18.0, 17.0),
            size: Size(360.0, 640.0),
            fixedHeight: true,
            child:
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(16.0, 356.0, 328.0, 64.0),
            size: Size(360.0, 640.0),
            pinLeft: true,
            pinRight: true,
            fixedHeight: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(16.0, 436.0, 181.0, 24.0),
            size: Size(360.0, 640.0),
            pinLeft: true,
            fixedWidth: true,
            fixedHeight: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(264.0, 440.0, 80.0, 16.0),
            size: Size(360.0, 640.0),
            pinRight: true,
            fixedWidth: true,
            fixedHeight: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(16.0, 468.0, 320.0, 80.0),
            size: Size(360.0, 640.0),
            pinLeft: true,
            pinRight: true,
            pinBottom: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(352.0, 468.0, 320.0, 80.0),
            size: Size(360.0, 640.0),
            pinRight: true,
            pinBottom: true,
            fixedWidth: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(329.0, 278.0, 18.0, 17.0),
            size: Size(360.0, 640.0),
            fixedHeight: true,
            child: Transform(
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(335.0, 280.0, 16.0, 16.0),
            size: Size(360.0, 640.0),
            pinRight: true,
            fixedWidth: true,
            fixedHeight: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(8.0, 280.0, 16.0, 16.0),
            size: Size(360.0, 640.0),
            pinLeft: true,
            fixedWidth: true,
            fixedHeight: true,
