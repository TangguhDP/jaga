...
import './ScreenDaftarPosko4.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:flutter_svg/flutter_svg.dart';

class ScreenDaftarPosko3 extends StatelessWidget {
  ScreenDaftarPosko3({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(16.0, 524.0, 24.0, 24.0),
            size: Size(360.0, 640.0),
            pinLeft: true,
            pinBottom: true,
            fixedWidth: true,
            ...
            child:
              ...
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => ScreenDaftarPosko4(),
                ),
              ],
              child: Container(
                decoration: BoxDecoration(
                  ...
                  color: const Color(0xffffffff),
                  border:
                      Border.all(width: 1.0, color: const Color(0xff3838a8)),
                ),
              ),
            ),
          ),
          Pinned.fromSize(
            bounds: Rect.fromLTWH(16.0, 352.0, 110.0, 22.0),
            size: Size(360.0, 640.0),
            pinLeft: true,
            fixedWidth: true,
            fixedHeight: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(16.0, 392.0, 328.0, 20.0),
            size: Size(360.0, 640.0),
            pinLeft: true,
            pinRight: true,
            fixedHeight: true,
            child:
              ...
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                  ...
                  colors: [const Color(0xffefeeee), const Color(0xffb1b1b1)],
                  stops: [0.0, 1.0],
                ),
              ),
            ),
