...
class ScreenPosko extends StatelessWidget {
  ScreenPosko({
    Key key,
  }) : super(key: key);
  @override
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [const Color(0x25000000), const Color(0x00d8d8d8)],
                stops: [0.0, 1.0],
              ),
            ),
          ),
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(3.0, 3.0, 10.0, 10.0),
                    size: Size(16.0, 16.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(16.0, 16.0, 28.0, 26.0),
                    size: Size(360.0, 84.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'adjust - material' (text)
                        Text(
                      '',
                      style: TextStyle(
                        fontFamily: 'material',
...
const String _svg_dru78m =
    '<svg viewBox="0.0 0.0 360.0 84.0" ><path  d="M 0 0 L 360 0 L 360 84 L 0 84 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="10" stroke-linecap="butt" /></svg>';
const String _svg_7y59tk =
...
const String _svg_42d4xu =
    '<svg viewBox="0.0 0.0 56.0 24.0" ><path  d="M 12 0 L 44 0 C 50.62741851806641 0 56 5.37258243560791 56 12 C 56 18.62741851806641 50.62741851806641 24 44 24 L 12 24 C 5.37258243560791 24 0 18.62741851806641 0 12 C 0 5.37258243560791 5.37258243560791 0 12 0 Z" fill="#e31f52" stroke="none" stroke-width="1" stroke-miterlimit="10" stroke-linecap="butt" /></svg>';
