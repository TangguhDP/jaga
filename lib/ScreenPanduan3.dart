...
class ScreenPanduan3 extends StatelessWidget {
  ScreenPanduan3({
    Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromSize(
            ...
            fixedHeight: true,
            child:
                // Adobe XD layer: 'Group 23@3x' (shape)
                Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage('assets/images/img_panduan3.png'),
                  fit: BoxFit.fill,
                ),
              ),
            ),
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  ...
                  fixedHeight: true,
                  child: Text(
                    'Bawa kendaraan pribadi menuju lokasi yang aman',
                    style: TextStyle(
                      fontFamily: 'Rubik',
                      fontSize: 16,
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  ...
                  fixedHeight: true,
                  child: Text(
                    'Letakan benda berharga & elektronik ditempat tinggi > 2 meter',
                    style: TextStyle(
                      fontFamily: 'Rubik',
                      fontSize: 16,
                      color: const Color(0xff000000),
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  ...
                  fixedHeight: true,
                  child: Text(
                    'Cabut peralatan yang tersambung dengan listrik',
                    style: TextStyle(
                      fontFamily: 'Rubik',
                      fontSize: 16,
                      color: const Color(0xff000000),
          ...
          Pinned.fromSize(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(72.0, 31.0, 129.0, 19.0),
                  size: Size(360.0, 80.0),
                  fixedWidth: true,
                  fixedHeight: true,
                  child: Text(
                  ...
                  Pinned.fromSize(
                    ...
                    child:
                      ...
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(135.0, 11.0, 58.0, 19.0),
                          size: Size(328.0, 40.0),
                          fixedHeight: true,
                          child:
