...
import 'package:jaga_app/ScreenDonasi.dart';
          ...
          children: [
            Row(
              children: [
                ...
                // Adobe XD layer: 'Group Lokasi' (group)
                PageLink(
                  links: [
                    PageLinkInfo(
                  ...
                  child: SizedBox(
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(48.0, 20.0, 60.0, 14.0),
                          size: Size(158.0, 34.0),
                          fixedHeight: true,
                          child:
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(148.0, 5.0, 10.0, 6.0),
                          size: Size(158.0, 34.0),
                          pinRight: true,
                          pinTop: true,
                          fixedWidth: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 3.0, 7.0, 10.0),
                          size: Size(158.0, 34.0),
                          pinLeft: true,
                          pinTop: true,
                          fixedWidth: true,
            ...
            Center(
              child: // Adobe XD layer: 'Group 5@3x' (shape)
                  Container(
                ...
                children: [
                    ...
                    child: SizedBox(
                      ...
                      child: Stack(
                        children: <Widget>[
                          ...
                          Pinned.fromSize(
                            bounds: Rect.fromLTWH(16.0, 28.3, 39.6, 19.3),
                            size: Size(72.0, 86.0),
                            pinLeft: true,
                            pinRight: true,
                            fixedHeight: true,
                                ...
                                Pinned.fromSize(
                                  ...
                                  child:
                                    ...
                                    children: <Widget>[
                                      Pinned.fromSize(
                                        bounds:
                                            Rect.fromLTWH(0.0, 0.0, 39.6, 24.3),
                                        size: Size(39.6, 24.3),
                                        pinLeft: true,
                                        pinRight: true,
                                        pinTop: true,
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => ScreenDonasi()),
                      );
                    },
                    child: SizedBox(
                      width: 64.0,
                                ...
                                Pinned.fromSize(
                                  ...
                                  child:
                                    ...
                                    children: <Widget>[
                                      Pinned.fromSize(
                                        bounds:
                                            Rect.fromLTWH(13.0, 0.0, 10.3, 5.8),
                                        size: Size(31.2, 31.9),
                                        pinTop: true,
                                        fixedWidth: true,
                                        fixedHeight: true,
                                      ...
                                      Pinned.fromSize(
                                        bounds:
                                            Rect.fromLTWH(9.7, 6.7, 18.2, 16.2),
                                        size: Size(31.2, 31.9),
                                        pinRight: true,
                                        fixedWidth: true,
                                        fixedHeight: true,
                                      ...
                                      Pinned.fromSize(
                                        bounds:
                                            Rect.fromLTWH(0.0, 17.1, 7.9, 12.1),
                                        size: Size(31.2, 31.9),
                                        pinLeft: true,
                                        pinBottom: true,
                                        fixedWidth: true,
